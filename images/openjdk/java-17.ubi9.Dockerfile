...
ENV LANGPACK_DOWNLOAD_URL=https://rpmfind.net/linux/centos-stream/9-stream/BaseOS/x86_64/os/Packages
...
ENV EPEL_URL="https://dl.fedoraproject.org/pub/epel/epel-release-latest-9.noarch.rpm"
